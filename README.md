...
| Slope Angle (θ) | Multiplier Formula | Range |
|-----------------|-----------------|-----------------|
| θ ≤ 5° | 1.0 + (θ / 5.0) × 0.2 | [1.0, 1.2]× |
| 5° < θ ≤ 10° | 1.2 + ((θ - 5) / 5.0) × 0.3 | [1.2, 1.5]× |
| 10° < θ ≤ 15° | 1.5 + ((θ - 10) / 5.0) × 1.0 | [1.5, 2.5]× |
| θ > 15° | 2.5 + ((θ - 15) / 10.0) × 1.5 | [2.5, 4.0]× |
...
| Slope Angle (θ) | Multiplier Formula | Range |
|-----------------|-----------------|-----------------|
| θ ≤ 15° | 0.9 - (θ / 15.0) × 0.2  | [0.9, 0.7]× |
| 15° < θ ≤ 45° | 0.7 - ((θ - 15) / 30.0) × 0.2 | [0.7, 0.5]× |
| θ > 45° | 0.5 - ((θ - 45) / 45.0) × 0.2 | [0.5, 0.3]× |
